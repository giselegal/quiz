...
const ResultPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden" style={getStyleOverrides()}>
      ...
      <div className="absolute bottom-0 left-0 w-1/3 h-1/3 bg-[#aa6b5d]/5 rounded-full blur-3xl translate-y-1/3 -translate-x-1/3"></div>
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl relative z-10">
        {/* Card principal com resultado do estilo */}
        <Card className="p-8 mb-12 bg-white/90 backdrop-blur-sm shadow-lg border border-[#B89B7A]/30 rounded-xl">
          <AnimatedWrapper animation="fade" show={true} duration={600} delay={100}>
            <div className="text-center mb-10">
              <h1 className="text-2xl md:text-3xl font-playfair text-[#432818] mb-6">Seu Estilo Predominante</h1>
              <div className="max-w-md mx-auto mb-6">
                ...
                <Progress value={primaryStyle.percentage} className="h-3 bg-[#F3E8E6]" indicatorClassName="bg-gradient-to-r from-[#B89B7A] to-[#aa6b5d]" />
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div className="space-y-6 order-2 md:order-1">
                ...
                <AnimatedWrapper animation={isLowPerformance ? 'none' : 'fade'} show={true} duration={400} delay={200}>
                  <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-md border border-[#B89B7A]/20">
              ...
              <AnimatedWrapper animation={isLowPerformance ? 'none' : 'scale'} show={true} duration={500} delay={100} className="order-1 md:order-2">
                <div className="max-w-[220px] md:max-w-[280px] mx-auto relative">
                  <OptimizedImage 
                    src={image}
                    alt={`Estilo ${category}`}
                    width={280}
                    height={Math.round(280 * 1.3)}
                    className="w-full h-auto rounded-xl shadow-lg hover:scale-105 transition-transform duration-300"
                    priority={true}
                  />
                  <div className="absolute -top-3 -right-3 w-10 h-10 border-t-2 border-r-2 border-[#B89B7A] dark:border-[#E0C9B1]"></div>
                  <div className="absolute -bottom-3 -left-3 w-10 h-10 border-b-2 border-l-2 border-[#B89B7A] dark:border-[#E0C9B1]"></div>
                </div>
              </AnimatedWrapper>
            </div>
        ...
        <AnimatedWrapper animation={isLowPerformance ? 'none' : 'fade'} show={true} duration={400} delay={950}>
          <div className="text-center my-12">
              <div className="bg-[#f9f6f2] p-7 rounded-xl border border-[#B89B7A]/20 shadow-md mb-8">
                ...
                <div className="flex justify-center">
                  <ArrowDown className="w-9 h-9 text-[#B89B7A] animate-bounce" />
                </div>
              </div>
              ...
              <div className="mt-3 inline-block bg-[#aa6b5d]/10 px-4 py-1.5 rounded-full">
        ...
        <AnimatedWrapper animation={isLowPerformance ? 'none' : 'fade'} show={true} duration={400} delay={1100}>
          ...
          <div className="text-center mt-10">
            ...
            <div className="mx-auto w-20 h-1 bg-gradient-to-r from-[#B89B7A] to-[#aa6b5d] rounded-full mb-6"></div>
            <p className="text-[#432818] mb-8 max-w-xl mx-auto text-base md:text-lg leading-relaxed">
            ...
            <div className="bg-gradient-to-r from-[#fff8f4] to-[#faf5f0] p-7 rounded-xl mb-8 border border-[#B89B7A]/20 shadow-md">
              <h3 className="text-xl md:text-2xl font-medium text-[#aa6b5d] mb-5">O Guia de Estilo e Imagem + Bônus Exclusivos</h3>
              <ul className="space-y-4 text-left max-w-xl mx-auto text-[#432818]">
            ...
            <div className="bg-white p-7 rounded-xl shadow-xl border border-[#B89B7A]/20 mb-10 max-w-md mx-auto transform hover:scale-[1.02] transition-transform duration-300">
              <h3 className="text-xl md:text-2xl font-medium text-center text-[#aa6b5d] mb-5">O Que Você Recebe Hoje</h3>
              ...
              <div className="text-center p-5 bg-[#f9f5f0] rounded-lg border border-[#B89B7A]/10">
                ...
                <p className="text-4xl font-bold bg-gradient-to-r from-[#B89B7A] to-[#aa6b5d] bg-clip-text text-transparent">{priceInfo.currentPrice}</p>
            ...
            <Button onClick={handleCTAClick} className="text-white py-5 px-8 rounded-xl shadow-lg transition-all duration-300 transform hover:scale-105 active:scale-95 mb-3" style={{
              background: "linear-gradient(to right, #4CAF50, #45a049)",
              boxShadow: "0 6px 18px rgba(76, 175, 80, 0.35)",
              fontSize: "1.1rem"
