...
import { Trash2, RefreshCcw, Info, Play, CheckCircle, Eye, Users, ShoppingCart, MousePointer, AlertTriangle } from 'lucide-react';
import { analyzePixelEvents, getPixelHealthScore } from '@/utils/pixelAnalysis';
        ...
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              <Badge variant={healthScore >= 80 ? "default" : healthScore >= 60 ? "secondary" : "destructive"} className="text-xs">
                Saúde: {healthScore}%
              </Badge>
              {healthScore < 80 && (
