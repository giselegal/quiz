...
const QUIZ_TEMPLATES = {
  ...
  result: {
    id: "result-real",
    title: "Resultado do Quiz - Página Completa",
    ...
    components: [
      {
        id: "header-result",
        type: "title" as const,
        data: { text: "Olá, [NOME], seu Estilo Predominante é:" },
        style: {
          fontSize: "2rem",
          fontWeight: "600",
          textAlign: "center" as const,
      ...
      },
      {
        ...
        type: "subtitle" as const,
        data: {
          text: "Você tem um gosto refinado e aprecia peças atemporais que transmitem sofisticação sem ostentação. Seu estilo é caracterizado por linhas limpas, cortes impecáveis e uma paleta de cores neutras e elegantes.",
        },
        style: {
          fontSize: "1rem",
          textAlign: "center" as const,
      ...
      },
      {
        ...
        type: "title" as const,
        data: { text: "Seus Estilos Secundários" },
        style: {
          fontSize: "1.5rem",
          fontWeight: "600",
          textAlign: "center" as const,
      ...
      {
        id: "secondary-styles-list",
        type: "subtitle" as const,
        data: {
          text: "• Contemporâneo (20%)\n• Romântico (17%)\n• Sexy (13%)\n• Natural (10%)",
        },
        style: {
          fontSize: "1rem",
      ...
      },
      {
        id: "offer-section",
        type: "title" as const,
        data: { text: "🎯 Transforme Seu Estilo Agora" },
        style: {
          fontSize: "2rem",
          fontWeight: "700",
          textAlign: "center" as const,
      ...
      },
      {
        ...
        type: "subtitle" as const,
        data: {
          text: "Descubra como aplicar seu estilo ELEGANTE no dia a dia com nosso curso exclusivo. Aprenda a montar looks perfeitos para cada ocasião.",
        },
        style: {
          fontSize: "1.1rem",
          textAlign: "center" as const,
      ...
      },
      {
        ...
        type: "title" as const,
        data: { text: "✨ Antes e Depois da Transformação" },
        style: {
          fontSize: "1.8rem",
          fontWeight: "600",
          textAlign: "center" as const,
      ...
      },
      {
        ...
        type: "subtitle" as const,
        data: {
          text: "Veja como outras mulheres transformaram completamente seus guarda-roupas e ganharam confiança para arrasar em qualquer situação.",
        },
        style: {
          fontSize: "1rem",
          textAlign: "center" as const,
      ...
      },
      {
        id: "guarantee-title",
        type: "title" as const,
        data: { text: "🛡️ Garantia Incondicional" },
        style: {
          fontSize: "1.8rem",
          fontWeight: "600",
          textAlign: "center" as const,
      ...
      },
      {
        ...
        type: "subtitle" as const,
        data: {
          text: "Se você não ficar 100% satisfeita com os resultados em 30 dias, devolvemos todo seu dinheiro. Sem perguntas, sem burocracia!",
        },
        style: {
          fontSize: "1rem",
          textAlign: "center" as const,
